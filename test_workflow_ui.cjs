...
const reviewCase={...c,diffs:[{id:'d1',code:'management_fee',label:'管理費',old_value:12000,new_value:13500,review_status:'unreviewed',can_adopt:true,source:'最新重調'},{id:'d2',code:'repair_reserve_fee',label:'修繕積立金',old_value:8000,new_value:9000,review_status:'unreviewed',can_adopt:true,source:'最新重調'}]};
ui.renderReview(reviewCase,panel);assert(panel.innerHTML.includes('残り 2件'));assert(panel.innerHTML.includes('管理費'));assert(!panel.innerHTML.includes('修繕積立金'));assert(panel.innerHTML.includes('現在の値を使う'));assert(!panel.innerHTML.includes('契約書生成へ'));
